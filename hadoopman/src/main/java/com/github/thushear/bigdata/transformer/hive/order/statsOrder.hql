...
-- 4. 创建function
create function currency_type_convert as 'com.beifeng.transformer.hive.CurrencyTypeDimensionUDF' using jar 'hdfs://hh:8020/beifeng/transformer/transformer-0.0.1.jar';
create function payment_type_convert as 'com.beifeng.transformer.hive.PaymentTypeDimensionUDF' using jar 'hdfs://hh:8020/beifeng/transformer/transformer-0.0.1.jar';
create function order_info as 'com.beifeng.transformer.hive.OrderInfoUDF' using jar 'hdfs://hh:8020/beifeng/transformer/transformer-0.0.1.jar';
create function order_total_amount as 'com.beifeng.transformer.hive.OrderTotalAmountUDF' using jar 'hdfs://hh:8020/beifeng/transformer/transformer-0.0.1.jar';
