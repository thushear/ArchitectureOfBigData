...
//		jdbcHelper.executeBatch(sql, paramsList);
    ...
    String taskSql = "insert into task(task_name,create_time,start_time,finish_time,task_type,task_status,task_param) values(?,?,?,?,?,?,?)";
//    String taskParam = "{startDate:2017-01-08,endDate:2017-01-11}";
